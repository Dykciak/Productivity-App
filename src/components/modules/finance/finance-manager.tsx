...
import { IncomeCategories } from "@/components/modules/finance/income-categories";
...
import type { BudgetCategory, IncomeCategory, SavingsGoal, Transaction } from "@/lib/types";
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <Card className="bento-cell">
          ...
          <CardContent>
            <QuickExpenseEntry budgetCategories={budgetCategories} incomeCategories={incomeCategories} />
          </CardContent>
        </Card>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <Card className="bento-cell">
          ...
          <CardContent>
            <IncomeCategories categories={incomeCategories} transactions={transactions} />
          </CardContent>
        </Card>
